...
export const BROKER_LENDER_ON_LENDER_DOCUMENT_CATEGORY_FIELD_ID =
  '6b6d0000-4121-4000-8000-000000000001';
export const LENDER_DOCUMENT_CATEGORIES_ON_BROKER_LENDER_FIELD_ID =
  '6b6d0000-4121-4000-8000-000000000002';

export default defineField({
  universalIdentifier: BROKER_LENDER_ON_LENDER_DOCUMENT_CATEGORY_FIELD_ID,
