...
import { BROKER_STAGE_TEMPLATES_VIEW_ID } from 'src/views/broker-stage-templates.view';
import {
...
export default defineNavigationMenuItem({
  universalIdentifier: '6b6d0000-3100-4000-8000-000000000007',
  name: 'Stage templates',
  icon: 'IconProgress',
  position: 17,
  type: NavigationMenuItemType.VIEW,
  viewUniversalIdentifier: BROKER_STAGE_TEMPLATES_VIEW_ID,
