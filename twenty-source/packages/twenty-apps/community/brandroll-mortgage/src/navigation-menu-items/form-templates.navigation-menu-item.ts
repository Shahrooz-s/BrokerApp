...
import { BROKER_FORM_TEMPLATES_VIEW_ID } from 'src/views/broker-form-templates.view';
import {
...
export default defineNavigationMenuItem({
  universalIdentifier: '6b6d0000-3100-4000-8000-000000000002',
  name: 'Form templates',
  icon: 'IconForms',
  position: 10,
  type: NavigationMenuItemType.VIEW,
  viewUniversalIdentifier: BROKER_FORM_TEMPLATES_VIEW_ID,
