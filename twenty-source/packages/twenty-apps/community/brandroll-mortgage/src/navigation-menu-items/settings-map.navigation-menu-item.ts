...
import { BROKER_SETTINGS_AREAS_VIEW_ID } from 'src/views/broker-settings-areas.view';
import {
...
export default defineNavigationMenuItem({
  universalIdentifier: '6b6d0000-3100-4000-8000-000000000008',
  name: 'Settings map',
  icon: 'IconSettings',
  position: 5,
  type: NavigationMenuItemType.VIEW,
  viewUniversalIdentifier: BROKER_SETTINGS_AREAS_VIEW_ID,
