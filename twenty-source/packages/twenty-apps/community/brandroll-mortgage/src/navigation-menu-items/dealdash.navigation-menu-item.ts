...
import { BROKERAPP_LOANDASH_PAGE_LAYOUT_ID } from 'src/page-layouts/brokerapp-dealdash.page-layout';
import {
...
export default defineNavigationMenuItem({
  ...
  pageLayoutUniversalIdentifier: BROKERAPP_LOANDASH_PAGE_LAYOUT_ID,
