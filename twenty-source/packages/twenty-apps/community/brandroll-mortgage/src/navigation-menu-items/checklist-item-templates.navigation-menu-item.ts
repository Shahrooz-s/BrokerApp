...
import { BROKER_CHECKLIST_ITEM_TEMPLATES_VIEW_ID } from 'src/views/broker-checklist-item-templates.view';
import {
...
export default defineNavigationMenuItem({
  universalIdentifier: '6b6d0000-3100-4000-8000-000000000012',
  name: 'Checklist item templates',
  icon: 'IconListDetails',
  position: 41,
  type: NavigationMenuItemType.VIEW,
  viewUniversalIdentifier: BROKER_CHECKLIST_ITEM_TEMPLATES_VIEW_ID,
