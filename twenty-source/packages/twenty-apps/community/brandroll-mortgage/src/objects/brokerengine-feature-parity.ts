  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'LOANDASH', label: 'LoanDash', position: 1, color: 'green' },
        {
          value: 'FACT_FIND',
          label: 'Fact find',
          position: 2,
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 'PRIVATE_IMPORT_REQUIRED',
          label: 'Private import required',
          position: 2,
          color: 'orange',
        },
        {
          value: 'WORKSPACE_CONFIG_REQUIRED',
          label: 'Workspace config required',
          position: 3,
          color: 'yellow',
        },
        {
        ...
        {
          value: 'CUSTOM_UI_REQUIRED',
          label: 'Custom UI required',
          position: 5,
          color: 'purple',
        },
        {
