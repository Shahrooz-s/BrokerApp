...
- Recovery build note: `0.16.56` keeps the BrokerApp LoanDash front component active, disables URL hash writes in the front-component sandbox, renders a safe LoanDash preview in board quick-view drawers, keeps desktop panels user-controlled instead of auto-collapsing from measured width, and adds visible panel width controls as a fallback to drag resizing.
